	...
	<?php
		foreach ($lesSoirees as $Soiree) {
	            echo $Soiree->getNom()." ";
                    ...
                    echo "<button><a href='index.php?controleur='soiree'&action='supprimerSoiree'&id=".$Soiree->getId()."'><img src='Images/supprimer.png' max-width='50px' max-height='50px'></a></button>";
